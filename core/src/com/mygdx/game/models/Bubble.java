...
public class Bubble extends TextualObject {
    ...
    public Bubble(Vector2 position, SemanticWord word, float duration) {
        ...
        glyphLayout = new GlyphLayout(font, word.getValue(VocabularyProvider.getInstance().getLanguageWantToLearn()));
